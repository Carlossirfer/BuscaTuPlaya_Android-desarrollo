...
package es.miotek.pablo_santos.buscatuplaya.clustering.view;
...
import es.miotek.pablo_santos.buscatuplaya.*;
...
public class DefaultClusterRenderer<T extends ClusterItem > implements ClusterRenderer<T> {
    ...
    private final es.miotek.pablo_santos.buscatuplaya.clustering.ClusterManager<T> mClusterManager;
    ...
    public DefaultClusterRenderer(Context context, GoogleMap map, es.miotek.pablo_santos.buscatuplaya.clustering.ClusterManager<T> clusterManager) {
        mMap = map;
        mAnimate = true;
