...
package es.miotek.pablo_santos.buscatuplaya.clustering;
...
import es.miotek.pablo_santos.buscatuplaya.clustering.view.DefaultClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public void onCameraIdle() {
        ...
        //COGEMOS LA LATITUD Y LONGITUD
        Fragment_map.LAT=mMap.getCameraPosition().target.latitude;
     ...
     */
    public void setOnClusterClickListener(com.google.maps.android.clustering.ClusterManager.OnClusterClickListener<T> listener) {
     ...
     */
    public void setOnClusterInfoWindowClickListener(com.google.maps.android.clustering.ClusterManager.OnClusterInfoWindowClickListener<T> listener) {
     ...
     */
    public void setOnClusterItemClickListener(com.google.maps.android.clustering.ClusterManager.OnClusterItemClickListener<T> listener) {
     ...
     */
    public void setOnClusterItemInfoWindowClickListener(com.google.maps.android.clustering.ClusterManager.OnClusterItemInfoWindowClickListener<T> listener) {
